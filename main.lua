...
function love.load()
  ...
  sounds = {
    ['paddle_hit'] = love.audio.newSource('PongSounds/BLip_Select7.wav','static'),
    ['score'] = love.audio.newSource('PongSounds/Explosion.wav', 'static'),
    ['wall_hit'] = love.audio.newSource('PongSounds/Hit_Hurt.wav', 'static')
  }
...
function love.draw()
  ...
  love.graphics.clear(0.177, 0.2, 0.231, 1)
